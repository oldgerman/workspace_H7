...
#ifndef LCD_LCD_TOUCH_H_
#define LCD_LCD_TOUCH_H_
...
#define GT911_ADDR1 ((uint8_t)0x5D << 1)
#define GT911_ADDR2 ((uint8_t)0x14 << 1)
...
class TAMC_GT911 {
public:
    TAMC_GT911(uint16_t _width, uint16_t _height);
