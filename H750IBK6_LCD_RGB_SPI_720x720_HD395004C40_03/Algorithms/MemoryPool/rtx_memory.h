/**
  ...
  *    2024-01-04  添加calloc、realloc
  *                但 aligned_calloc、aligned_realloc 找不到实现
  *
  ******************************************************************************
  * 模块名称 : 动态内存管理
  * 文件名称 : rtx_memory.h
...
public:
    ...
    //void*       aligned_calloc(size_t num, size_t nsize, size_t alignment);
    //void*       aligned_realloc(void* block, size_t size, size_t alignment);
