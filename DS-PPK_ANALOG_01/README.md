...
5V VLDO，使能500R校准电阻，此时在10~100mA档，ADC 100Hz，抖动 9.982-9.952 = 0.03mA，1/(0.03/(100-10) = 3000，约11.5bit的无抖动精度

![](Images/10~100mA档校准接电阻的直方图.png)

### 校准档位 100~2000mA档

5V VLDO，使能50R校准电阻，此时在100~2000mA档，ADC 100Hz，抖动 103.8 - 102.9 = 0.9mA，1/(0.9/(2000-100) = 2111，约11bit的无抖动精度

![](Images/100~2000mA档校准接电阻的直方图.png)

## 直方图分析 | 100KHz

```c
	/* 配置触发ADC的定时器 */
	bsp_LPTIMx_PWM_Set(&hlptim1, 6400000, 100000, 50);
```

ADC DMA仅设置 1 个缓冲区，打印数据的线程调度频率1000Hz

5V VLDO，使能500KR校准接电阻，此时在0~100uA档，ADC 100KHz，抖动 10.055-10.015 = 0.04mA，1/(0.04/(100-10) = 2250，约11bit多一点点的无抖动精度

### 校准档位 10~100mA档

5V VLDO，使能500R校准电阻，此时在10~100mA档，ADC 100KHz，抖动 10.000-9.950 = 0.05mA，1/(0.05/(100-10) = 1800，接近11bit无抖动精度

![](Images/10~100mA档校准接电阻的直方图100KHz.png)

### 校准档位 100~2000mA档

5V VLDO，使能50R校准电阻，此时在100~2000mA档，ADC 100Hz，抖动 103.900- 103.000 = 0.900mA，1/(0.90/(2000-100) = 2111，约11bit无抖动精度

![](Images/100~2000mA档校准接电阻的直方图100KHz.png)
