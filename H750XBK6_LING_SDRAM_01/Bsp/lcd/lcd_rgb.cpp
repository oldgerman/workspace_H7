...
//    HAL_GPIO_WritePin(SPI4_CS_GPIO_Port, SPI4_CS_Pin, GPIO_PIN_RESET);
    ...
    if(HAL_SPI_Transmit(&hspi4, (uint8_t *)(&data), 1, HAL_MAX_DELAY) != HAL_OK)
...
void LCD_Init()
{
    ...
    Wrt_Reg_3052(0xFF,0x30);
        ...
        //Wrt_Reg_3052(0x40,0x00);//DELECT
        //Wrt_Reg_3052(0x03,0x40);
        Wrt_Reg_3052(0x04,0x00);
        Wrt_Reg_3052(0x05,0x00);
        ...
        Wrt_Reg_3052(0x30,0x18);//add68

        Wrt_Reg_3052(0x38,0x9C);
        Wrt_Reg_3052(0x39,0xA7);
        Wrt_Reg_3052(0x3A,0x4C); //3A//OTP60

        Wrt_Reg_3052(0x28,0x40);
        Wrt_Reg_3052(0x29,0x01);
        Wrt_Reg_3052(0x2A,0xdf);
        Wrt_Reg_3052(0x49,0x3C);
        Wrt_Reg_3052(0x91,0x77); //57
        Wrt_Reg_3052(0x92,0x77); //57
        Wrt_Reg_3052(0x98,0x46); //ADD
        ...
        Wrt_Reg_3052(0xB4,0x03);  //33//OTP150
    ...
    Wrt_Reg_3052(0xD0,0x0B);
        ...
        Wrt_Reg_3052(0x34,0x61);//6A//OTP364
        ...
        Wrt_Reg_3052(0x11,0x00);     //sleep out
    LCD_Delay(120);
