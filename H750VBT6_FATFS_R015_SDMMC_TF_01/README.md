...
| 备注           | 设置频率（Hz） | 实际频率（Hz） | 实际频率波动（Hz） | CPU 利用率（%） | 吞吐量（KB/s） |                      |
| -------------- | -------------- | -------------- | ------------------ | --------------- | -------------- | -------------------- |
| 已有文件*      | 200            | 165            | 105 - 167          | 16              | N/A            |                      |
| 已有文件*      | 100            | 100            | 82 - 116           | 15              | 3217.5         | 偶尔波动，不太稳定   |
| 已有文件       | 32             | 32.x           | 32.0- 32.5         | 5               | 1029.6         | 有在项目中应用的可能 |
| 删除并新建文件 | 200            | 94 - 110       | 81- 126            | 41              | N/A            |                      |
| 删除并新建文件 | 100            | 100            | 74 -121            | 40              | 3217.5         |                      |
| 删除并新建文件 | 32             | 32.x           | 32.0- 32.5         | 12              | 1029.6         | 有在项目中应用的可能 |
